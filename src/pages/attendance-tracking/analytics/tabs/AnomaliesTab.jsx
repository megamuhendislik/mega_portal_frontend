...
import { Tag, Tooltip, Slider, Button, Empty, Segmented } from 'antd';
import {
    AlertTriangle, TrendingUp, TrendingDown, User, Info, Filter,
    RotateCw, Sparkles, Activity,
} from 'lucide-react';
 ...
 *
 * Banner'a (AnomaliesPanel) göre farkları:
 *  - Severity filtreleme
 *  - Metrik filtresi (overtime/worked/absence/meal)
 *  - Direction filtresi (above/below)
 *  - Threshold slider (1.5σ – 3.0σ)
 *  - Manuel refresh butonu
 *  - Tam-ekran kartlar (banner'da satır liste)
 *  - Top 30 anomali (banner top 8'den geniş)
 *
 * Backend: GET /api/attendance-analytics/anomalies/?threshold=...
 */
                    ...
                    {filtered.map((a, idx) => {
                        ...
                        return (
                            <div
                                ...
                                className={`rounded-xl border ${cfg.border} ${cfg.bg} p-4 shadow-sm hover:shadow-md transition-shadow`}
                            >
