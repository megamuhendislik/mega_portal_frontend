...
const Profile = () => {
    ...
    return (
        <div className="flex flex-col md:flex-row h-auto md:h-[calc(100vh-64px)] bg-slate-50 overflow-hidden font-inter">
            {/* Sidebar */}
            <div className="w-full md:w-72 bg-white border-b md:border-b-0 md:border-r border-slate-200 flex flex-col md:shrink-0">
                ...
                <nav className="flex-1 overflow-x-auto md:overflow-x-visible overflow-y-auto px-3 flex flex-row md:flex-col gap-1 md:space-y-1 md:gap-0">
                    {tabs.map(tab => {
                        const Icon = tab.icon;
