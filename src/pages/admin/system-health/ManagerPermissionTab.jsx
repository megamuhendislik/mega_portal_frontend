...
const SCENARIO_DEFS = [
    ...
    { num: 2, id: 'MGR-02', group: 'PRIMARY', desc: 'PRIMARY yönetici OT talebini onaylar' },
    ...
    { num: 8, id: 'MGR-08', group: 'SECONDARY_OT', desc: 'SECONDARY OT ataması yapabilir' },
    { num: 9, id: 'MGR-09', group: 'SECONDARY_OT', desc: 'SECONDARY OT ataması → bildirim oluşur' },
    { num: 10, id: 'MGR-10', group: 'CHECK_IN_GUARD', desc: 'Check-in yok → OT iptal edilebilir' },
    { num: 11, id: 'MGR-11', group: 'CHECK_IN_GUARD', desc: 'Check-in var → OT iptal engellenir (400)' },
    { num: 12, id: 'MGR-12', group: 'CHECK_IN_GUARD', desc: 'Check-in var → OT override engellenir (400)' },
...
const GROUP_FILTERS = [
    ...
    { key: 'SECONDARY_OT', label: 'SECONDARY OT' },
