...
const helpContent = [
    ...
    },
    {
        ...
        tips: [
            ...
            { type: 'info', text: 'Tolerans Ayarları: Servis toleransı (service_tolerance_minutes, varsayılan 0 dk) = servis kullanan personel için vardiya saatlerine yakın okutmaları yuvarlama. Bu değer 0 ise yuvarlama yapılmaz, şablonda tanımlanmalıdır. Tolerans (tolerance_minutes, varsayılan 30 dk) = vardiya sonrası uzatma penceresi; örneğin 18:00 bitişli vardiyada 18:30\'a kadar çıkış normal sayılır. Mola hakkı (daily_break_allowance, varsayılan 30 dk) = çalışma süresinden düşülecek mola süresi.' },
        ...
        faq: [
            { q: 'Yeni vardiya şablonu nasıl oluştururum?', a: '"Yeni Şablon" düğmesine tıklayın. Her gün (Pzt-Paz) için başlangıç-bitiş saatleri ve tatil durumunu tanımlayın. Servis toleransı, tolerans, mola hakkı ve minimum mesai eşiği ayarlarını yapın.' },
